...
public enum ResponseCode {
    ...
    CODE_IS_USED(215, "该激活码已被使用！"),

    PAY_IS_NOT_ENOUGH(216, "余额不足，请充值！"),

    DRAW_COUNT_NOT_ENOUGH(217, "绘画次数不足，联系平台管理员！"),

    OUTLINES_NOT_EXISTED(218, "该论文大纲不存在！"),

    CODE_NOT_EXISTED(219, "兑换码不正确！"),

    CODE_USED(220, "兑换码已被使用！"),
    ;
